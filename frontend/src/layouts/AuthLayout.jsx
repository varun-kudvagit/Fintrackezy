  ...
  return (
    <div className="flex">
      <div className="w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12">
        <h2 className="text-lg font-medium text-black">Fintrackezy</h2>
        <Outlet />
      </div>
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <img
          src={CARD2}
          className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15 border-none rounded-2xl"
        />
      </div>
    </div>
  );
